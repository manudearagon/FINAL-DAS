...
@XmlRootElement(name = "getAllSupermercadosResponse", namespace = "http://services.supermercadosws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllSupermercadosResponse", namespace = "http://services.supermercadosws.das.ubp.edu.ar/")
public class GetAllSupermercadosResponse {
