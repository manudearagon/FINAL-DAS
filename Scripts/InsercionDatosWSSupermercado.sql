...
VALUES
    ('30-87654321-2', 'Supermercado WS', 'Calle Verdadera', 124, '22222-2222');
...
VALUES
    (4, 'Sucursal Cofico', 'Avenida Siempre Viva', 742, '4444-5555', -34.6037, -58.3816, 1, 1);
INSERT INTO sucursales
    (nro_sucursal, nom_sucursal, calle, nro_calle, telefonos, coord_latitud, coord_longitud, nro_localidad, habilitada)
VALUES
    (5, 'Sucursal Cayetano', 'Calle Real', 123, '5555-6666', -34.6117, -58.3895, 2, 1);
INSERT INTO sucursales
    (nro_sucursal, nom_sucursal, calle, nro_calle, telefonos, coord_latitud, coord_longitud, nro_localidad, habilitada)
VALUES
    (6, 'Sucursal Si', 'Calle Imaginaria', 456, '6666-7777', -34.6181, -58.4011, 3, 0);
